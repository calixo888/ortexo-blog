...
export const meta = {
  ...
  summary:  "With technology becoming increasingly more advanced, nonprofits are harnessing its power to help better the world.",
  image: "/static/features/lightbulb.jpeg"
};
